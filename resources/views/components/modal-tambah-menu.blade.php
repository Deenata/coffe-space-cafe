<div id="modalTambahMenu" class="modal" style="display:none;">
    <div class="modal-content">
        <div class="modal-header">
            <h2>Tambah Menu</h2>
        </div>
        <div class="modal-body">
            <form class="modal-form" method="POST" action="{{ route('menu.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-inner">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="deskripsi" name="deskripsi" placeholder="Deskripsi menu" rows="2"></textarea>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-actions">
                    <button type="button" class="btn-cancel" onclick="document.getElementById('modalTambahMenu').style.display='none'">Batal</button>
                    <button type="submit" class="save-btn-wide">Tambah Menu</button>
                </div>
            </form>
        </div>
    </div>
