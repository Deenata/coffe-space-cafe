...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('/settings/account', [App\Http\Controllers\Admin\SettingsController::class, 'updateAccount'])->name('settings.account.update');
...
// Tidak ada route public untuk pelanggan
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::put('/pengaturan-akun', [App\Http\Controllers\Pelanggan\SettingsController::class, 'updateAccount'])->name('pelanggan.pengaturan.update');
    Route::put('/pengaturan-akun/password', [App\Http\Controllers\Pelanggan\SettingsController::class, 'updatePassword'])->name('pelanggan.pengaturan.password');
